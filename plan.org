...
|    2 | 10.03 | XV, Bootstrapping              | Generalisation                   | Train/Test/XV              |
|    3 | 10.10 | Perceptron                     | SGD, Convergence                 | Perceptron, Classification |
|    4 | 10.17 | Discriminative models          | Linear Regression, Least-Squares | As Theory                  |
|    5 | 10.24 | Generative Models              | Bayes Classifier                 | As Theory                  |
|    6 | 10.31 | Basis Functions                | GAMs                             | Feature selection          |
|    7 | 11.07 | Multi-Layer Neural Network     | Backpropagation                  | Network architectures      |
...
|   11 | 12.05 | Latent Variable Models         | Expectation Maximisation         | Gaussian Mixture Model     |
|   12 | 12.12 | Approximate Bayesian Inference | Monte-Carlo Methods              | Gaussian Mixture Model     |
|------+-------+--------------------------------+----------------------------------+----------------------------|
