...
|--------+-------+----------------------------+-------------------+------------------------------+-----------------------------------------|
|      1 | 09.17 | k Nearest neighbours       | Decision theory   | Train/Test/XV                | XV on a simple classifier               |
|      2 | 09.24 | The Perceptron             | Generalisation    | Bootstrapping and simulation | Simulation and real data                |
|      3 | 10.01 | The Perceptron             | SGD               | Perceptron, Classification   | Perceptron (Logistic Regression) vs kNN |
|      4 | 10.08 | Linear Regression          | Linear Regression | Linear Regression            | OLS vs SGD                              |
|      5 | 10.15 | Neural networks            | Backpropagation   |                              |                                         |
|      6 | 10.22 | Graphical models           | Bayes Classifier  | Bayes's theorem              |                                         |
|      7 | 10.29 | Probabilistic modelling    | Conjugate priors  | Beta-Bernoulli               |                                         |
|      9 | 11.05 | Sequence prediction        | Experiment design |                              |                                         |
|     10 | 11.12 | Latent variable estimation | Latent variables  |                              |                                         |
|     11 | 11.19 |                            |                   |                              |                                         |
|     12 | 11.26 | Fairness and Privacy       |                   |                              |                                         |
|     13 | 12.03 |                            |                   |                              |                                         |
|     14 | 12.10 | Project Presentations      |                   |                              |                                         |
|--------+-------+----------------------------+-------------------+------------------------------+-----------------------------------------|
