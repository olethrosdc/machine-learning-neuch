...
<<<<<<< HEAD
#+LaTeX_CLASS_OPTIONS: [smaller,notes]
=======
#+LaTeX_CLASS_OPTIONS: [smaller]
#+LATEX_HEADER: \setbeameroption{show notes}
>>>>>>> cbf4f0f6d1e51425e01a31c732b9fe25bb012e09
...
**** Which one do we use?
This course mainly follows the *Learning theory view*: it talks directly about $U(\pol, P)$, the quantity we actually care about, rather than about estimating some unrelated parameter $\theta$. The *Estimation theory view* is covered next for completeness. It's the classical framing you'll meet in statistics courses, and the two turn out to be closely related, but it doesn't add much that's new about *generalisation error* specifically.

=======
- Approximation ability: How well a *class of rules* can approximate the *optimal* one.
- Statistical error: How *easy* it is to choose the best rule in the class from *data*
- Directly bounds the generalisation error.
...
- *BSc*: You can skip this subsection. The geometric picture two slides back already gives you the intuition you need for generalisation error.
- *MSc*: Worth knowing — you'll meet "bias" and "variance" used exactly this way in statistics courses, and it's good to be fluent translating between the two framings.
>>>>>>> cbf4f0f6d1e51425e01a31c732b9fe25bb012e09
