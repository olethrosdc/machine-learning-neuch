...
** Activity 2: Predicitons vs Decisions           :activity:
*** Setup
...
*** Average behaviour of $k$
- Calculate the accuracy for 100 different synthetically generated training and testing datasets
...
- Write down the expected utility of action some $a$.
