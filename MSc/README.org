...
|      4 | 10.08 | Neural Network                 | Logistic Regression, Backpop, Stochastic GD         | pyTorch intro       | Mixed   |
|      5 | 10.15 | Regression, Linear             | Linear regression, Least Squares, Probabilistic     | pyTorch             | Mixed   |
|      6 | 10.22 | Quiz + Neural Network Lab      | Quiz + Linear Regression & NN Lab                   | pyTorch             | Lab     |
|--------+-------+--------------------------------+-----------------------------------------------------+---------------------+---------|
