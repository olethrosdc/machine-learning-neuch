...
1. Learning and generalisation. Concentration inequalities.
2. Convergence of SGD.
3. Prediction with expert advice.
4. Bayesian learning.
5. PAC-Bayes bounds.
6. The minimum description length principle.
7. Fairness and discrimination: conditional independence.
8. Fairness and meritocracy: smoothness.
9. Differential privacy and randomised response.
10. Laplace and Exponential mechanisms.
11. Privacy and generalisation.
12. Experiment design and Bayesian optimisation.
