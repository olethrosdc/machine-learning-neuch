...
|      4 | 10.10 | Regression, Linear          | Linear regression, Least Squares, Probabilistic     | pyTorch intro       | Mixed   |
|      5 | 10.17 | Project, Linear Regression  | Project discussion, Linear Regression Lab           | pyTorch             | Lab     |
|      6 | 10.24 | Neural Networks             | Features, GLMs, Backpop, Stochastic GD              | pyTorch             | Mixed   |
|--------+-------+-----------------------------+-----------------------------------------------------+---------------------+---------|
