...
|      4 | 10.08 | Neural Networks                | Logistic Regression, Backpop, Stochastic GD         | pyTorch intro       | Mixed   |
|      5 | 10.15 | Neural Network Lab             | Project discussion, Linear Regression Lab           | pyTorch             | Lab     |
|      6 | 10.22 | Regression, Linear             | Linear regression, Least Squares, Probabilistic     | pyTorch             | Mixed   |
|--------+-------+--------------------------------+-----------------------------------------------------+---------------------+---------|
